...
- https://github.com/alexlee-gk/slac/blob/master/slac/utils/gif_utils.py
- https://github.com/google-research/planet/blob/master/planet/tools/gif_summary.py
"""
...
@tf.contrib.eager.defun(autograph=False)  # don't use AutoGraph
def gif_summary_v2(name, tensor, max_outputs, fps, family=None, step=None):
    ...
    return summary_ops_v2.summary_writer_function(name, tensor, function, family=family)
